...
<head>
    ...
    <style type="text/css">
      ...
      @media only screen and (max-width: 1000px) {
      	.col-md-6{width: 90%;margin-left: 6%;padding-bottom: 5%;}
...
<div class="Form-login-and-register"><br><br><br><br>
	...
	<div class="row justify-content-md-center">
		<div class="col-md-6">
			<br><br><center><h2 style="color: white">Log in</h2></center><br>
			...
			<div class="row">
			  <div class="col">
                  <input type="submit" class="btn btn-warning form-control" value="Masuk" nama="login"
                  style="background: yellow;">
			  </div>
			</div><br>
			<p><font color="white">Kalau belum punya akun Klik &nbsp;&nbsp;<a href="form-register.php" style="color: yellow;font-weight: bold;">Sign Up</a></font></p>
		</div>
	</div>
	<br><br>
</div>
